...
| 파일 | 성격 | 내용 |
| --- | --- | --- |
| [spring-ai-study.md](./spring-ai-study.md) | 학습 자료 (본문) | Spring AI 2.0 개념부터 에이전트까지. 시작하기 → 핵심 기능 8개(ChatClient·Structured Output·ChatMemory·Tool Calling·RAG·ToolSearch·MCP·관측성) → 직접 만들어 보기. 위키 포팅 대상 |
